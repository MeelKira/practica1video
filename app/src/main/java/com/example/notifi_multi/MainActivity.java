...
Button ver_notifi,repAudio,rep_buttons;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rep_buttons=(Button)findViewById(R.id.rep_video);

        rep_buttons.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void reproducirVideo() {
        Uri myUri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.buttons);
    ...
    private void reproducirAudio() {
        Uri myUri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.llevatelo);
        MediaPlayer mediaPlayer = new MediaPlayer();
        try{
